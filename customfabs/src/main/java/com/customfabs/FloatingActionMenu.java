...
public class FloatingActionMenu {
     ...
     *
     * Are you measuring the view in onCreate(). The view isn't drawn yet.
     * You have to wait until a time after the view is drawn before you can measure it.
     * Simple solution for this is to post a runnable to the layout. The runnable will
     * be executed after the layout has happened.
     *
     * http://stackoverflow.com/questions/6939002/if-i-call-getmeasuredwidth-or-getwidth-for-layout-in-onresume-they-return-0/14425466#14425466
     *
     */
